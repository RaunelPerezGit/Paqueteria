...
<!--editar vehiculo-->
	<div class="modal fade" id="modalEditVehiculo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  		<div class="modal-dialog modal-m" role="document">
    		<div class="modal-content">
			...
			<div class="box-body">
		        <div class="form-group col-md-12 mb-3">
		        				<div class="col-md-12 mb-3">
		        				  <input type="hidden" name="idVeh" id="idVeh">
								</div>
								<div class="col-md-6 mb-3">
									<br>
									<label>Modelo:</label>
									<input type="text" class="form-control is-valid" name="modelo1"  id="modelo1" placeholder="Modelo" required="">
								</div>
								<div></div>
								<div class="col-md-6 mb-3">
									<br>
									<label>Marca:</label>
									<input type="text" class="form-control is-valid" name="marca1" id="marca1" placeholder="Marca" required="">
								</div>
								<div class="col-md-4 mb-3">
									<br>
									<label>Placas:</label>
									<input type="text" class="form-control is-valid" name="placas1" id="placas1" placeholder="Placas" required="">
								</div>
								
								<div class="col-md-8 mb-3">
									<br>
									<label>Capacidad Volumetrica:</label>
									<input type="number" class="form-control is-valid" name="capacidad1" id="capacidad1" placeholder="Capacidad volumétrica" required="">
								</div>
