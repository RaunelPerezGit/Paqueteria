					...
					<div class="panel panel-body col-md-6 mb-3">
						...
						<div class="col-md-12 mb-3 ">
							<div class="form-group">
								...
								<div class="col-md-6 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="telefonoR" name="telefonoR" placeholder="Telefono" required="">
								</div>
								...
								<div class="col-md-8 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="direccionR" name="direccionR" placeholder="direccion" required="">
								</div>
								<div class="col-md-4 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="cpCodR" name="cpCodR" placeholder="C. postal" required="">
								</div>
					...
					<div class="panel panel-primary">
						...
						<div class="col-md-12 mb-3 ">
							<div class="form-group">
								...
								<div class="col-md-6 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="telefonoD" name="telefonoD" placeholder="Telefono" required="">
								</div>
								...
								<div class="col-md-8 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="direccionD" name="direccionD" placeholder="direccion" required="">
								</div>
								<div class="col-md-4 mb-3">
									<br>
									<input type="text" class="form-control is-valid" id="cpCodD" name="cpCodD" placeholder="C. postal" required="">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="panel panel-heading col-md-12 mb-3">Paquete</div>
							...
							<div class="form-group">
								...
								<div class="col-md-12 mb-4">
								  ...
								  <input class="form-control form-control-sm" type="text" name="fethSal" value="<?php 
							...
							<div class="form-group">
								...
								<div class="col-md-12 mb-3 ">
									<br>
									<input type="number" id="largo" class="form-control is-valid" name="largo" placeholder="Largo (Cms.)" required="">
								</div>
								<div class="col-md-12 mb-3">
									<br>
									<input type="number" id="alto" class="form-control is-valid" name="alto" placeholder="Alto (Cms.)" required="">
								</div>
								<div class="col-md-12 mb-3">
									<br>
									<input type="number" id="ancho" class="form-control is-valid" name="ancho" placeholder="Ancho (Cms.)" required="">
								</div>
								<div class="col-md-12 mb-3">
									<br>
							...
							<div class="form-group">
								...
								<div class="col-md-12 mb-3">
									<br>
									<label for="imagen">Imágenen</label>
